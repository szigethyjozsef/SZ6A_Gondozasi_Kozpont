...
-- Tábla adatainak mentése 2021SZ_barabas_gergo.Korlap: ~4 rows (hozzávetőleg)
...
INSERT INTO `Korlap` (`K_ID`, `PACIENS_ID`, `OPERATOR_ID`, `LEIRAS`, `DATUM`) VALUES
	...
	(3, 1, 3, 'korlap/korlap_1_2026-03-02_10-47-08.pdf', '2026-03-02'),
	(4, 16, 1, 'korlap/korlap_16_2026-03-02_17-54-12.pdf', '2026-03-02');
...
INSERT INTO `Operatorok` (`O_ID`, `NEV`, `EMAIL`, `FELHASZNALONEV`, `PASSWORD`, `JOGOSULTSAG`) VALUES
	...
	(2, 'Boncz Ákos', 'bonczakos6@gmail.com', 'akos', '8ed358a7da3cc760364909d4aaf7321e', 'admin'),
	(3, 'Apoló Gizi', 'apologizi@gmail.com', 'gizi', '00c08ae98427567f86e1ec0660d629ad', 'apolo');
...
-- Tábla adatainak mentése 2021SZ_barabas_gergo.Paciens_Betegseg: ~96 rows (hozzávetőleg)
...
-- Tábla adatainak mentése 2021SZ_barabas_gergo.Paciens_Gyogyszer: ~62 rows (hozzávetőleg)
...
-- Tábla adatainak mentése 2021SZ_barabas_gergo.Paciens_Rokon: ~48 rows (hozzávetőleg)
...
INSERT INTO `Rokonok` (`R_ID`, `NEV`, `EMAIL`, `FELHASZNALONEV`, `PASSWORD`, `IRANYITOSZAM`, `TELEPULES`, `CIM`, `TELEFON`) VALUES
	(1, 'Horváth Tamás', 'horvath.tamas@freemail.hu', 'tamas', '0348643155599f4758255af31dbb4ab0', '1000', 'Budapest', 'Róna utca 12.', '06301112233'),
